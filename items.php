...
-->
            ...
            <div class="col-md-12 item-info">
                ...
                <img class="img-responsive img-thumbnail center-block" style = "margin: 0 auto; display: block; width: 25rem; height: 40rem;" 
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fa fa-money fa-fw"    aria-hidden="true"></i> <span>Author</span>: <?php echo $item['Author'] ?></li>
                    <li><i class="fa fa-building fa-fw" aria-hidden="true"></i> <span>Made By</span>: <?php echo $item['Publisher_Made'] ?></li>
